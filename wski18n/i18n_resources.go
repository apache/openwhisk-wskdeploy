...
func wski18nResourcesEn_usAllJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "wski18n/resources/en_US.all.json", size: 13734, mode: os.FileMode(420), modTime: time.Unix(1520545699, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
