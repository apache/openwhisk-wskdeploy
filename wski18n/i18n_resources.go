...
func wski18nResourcesEn_usAllJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "wski18n/resources/en_US.all.json", size: 14211, mode: os.FileMode(420), modTime: time.Unix(1515206275, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
