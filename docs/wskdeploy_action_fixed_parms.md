...
- [manifest_hello_world_fixed_parms.yaml](https://github.com/apache/incubator-openwhisk-wskdeploy/blob/master/docs/examples/manifest_hello_world_fixed_parms.yaml)
