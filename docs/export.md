...
Consider a simple manifest file [manifest_lib1.yml](https://github.com/davidbreitgand/incubator-openwhisk-wskdeploy/tests/src/integration/export/manifest_lib1.yml) for a sample project `lib1`.
